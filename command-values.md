...
<tr><td>2688</td><td>MultipleSelectAddNext</td><td>Add the next occurrence of the main selection to the set of selections as main. If the current selection is empty then select word around caret.</td></tr>
